    ...
    >
      ...
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-100 dark:border-gray-800 p-8 rounded-2xl w-full max-w-md mx-4 shadow-xl relative z-10">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Acesse sua conta para continuar</p>
        </div>
        ...
        <div className="mt-6 pt-5 border-t border-gray-100 dark:border-gray-800 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Não tem uma conta?{' '}
            <Link to="/register" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold hover:underline transition-colors">
              Cadastre-se
            </Link>
          </p>
        </div>
